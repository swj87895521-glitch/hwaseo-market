...
export const products: Product[] = [
  {
    id: 'product-tomato', slug: 'tomato', storeId: 'store-vegetable', category: '채소·과일',
  ...
  {
    id: 'product-tangerine', slug: 'tangerine', storeId: 'store-vegetable', category: '채소·과일',
  ...
  {
    id: 'product-oyster', slug: 'oyster', storeId: 'store-fish', category: '수산물',
  ...
  {
    id: 'product-shrimp', slug: 'shrimp', storeId: 'store-fish', category: '수산물',
  ...
  {
    id: 'product-sesameoil', slug: 'sesame-oil', storeId: 'store-oil', category: '가공식품',
  ...
  {
    id: 'product-doenjang', slug: 'doenjang', storeId: 'store-oil', category: '특산품',
